                                                ...
                                                <CardFooter>
                                                    <Row className="justify-content-center">
                                                        <Col md="6" lg="6" sm="6" className="justify-content-center">
                                                            <Row className="justify-content-center">
                                                                <Col md="12" lg="12" sm="6" className="justify-content-center">
                                                                    <Button className="justify-content-center btn border-0 rounded-pill btn-block" active style={{backgroundColor:"blue"}}>
                                                                        SEND
                                                                    </Button>
                                                                </Col>
                                                            </Row>
