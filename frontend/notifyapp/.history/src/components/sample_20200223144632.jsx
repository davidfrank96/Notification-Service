                            ...
                            <Col className="justify-content-center" lg="6" md="6" sm="12">
                                ...
                                <Row style={{ borderTop: "0.1px solid grey", borderBottom: "0.1px solid grey"}} className="justify-content-center w-50 text-black50 text-justify">
                                    <Col className="justify-content-center">
                                        <p>Please read your deluxe check carefully to ensure you fully understand all the information shown. If you have any questions regarding your deluxe check please contact us and we will be happy to help.</p>
                                    </Col>
                                </Row>
