...
import "./indes.css";
import { Row, Col, Card, CardBody, CardHeader, CardTitle, CardText, Input, CardFooter } from "reactstrap";
                                                ...
                                                <CardFooter>
                                                    <Row className="justify-content-center">
                                                        <Col md="6" lg="6" sm="6" className="justify-content-center">
                                                            <Button className="justify-content-center btn btn-primary" active>
                                                                SEND
                                                            </Button>
                                                        </Col>
                                                    </Row>
