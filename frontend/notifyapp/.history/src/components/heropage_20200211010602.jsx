            ...
            <>
                <div>
                    ...
                    <div className="justify-content-center pt-5 mt-5 py-5 my-5">
                        <Row className="justify-content-center bg-danger">
                            <Col lg="3" md="6" sm="12" className="bg-dark mx-3 justify-content-center">
                                <Input placeholder="ENTER REG"/>
                            </Col>
                            <Col lg="3" md="6" sm="12" className="bg-info mx-3 justify-content-center">
                                <Button small color="primary" active>Check Vehicle for Free</Button>
                            </Col>
                        </Row>

                        {/* <Row className="justify-content-center bg-danger">
                            <Col lg="6" md="12" sm="12" className="bg-dark mx-3 justify-content-center">
                                <Col lg="6" md="6" sm="6" className="bg-info mx-3 justify-content-center">
                                    <Button color="primary" active>Check Vehicle for Free</Button>
                                </Col>
                            </Col>
                        </Row> */}
                    </div>
                    {/* <Jumbotron className="h-100 rounded-0 justify-content-center bg-transparent"> */}
                        {/* <Row className="justify-content-center h-100 pt-5 mt-5 py-5 my-5">
                            <Col lg="6" md="6" sm="12">
                            ...
                            <Col lg="6" md="6" sm="12">
                                <Row className="h-100 justify-content-center">
                                    <Col lg="12" md="12" sm="12" className="h-100 justify-content-center">
                                        <Button color="primary" active>Check Vehicle for Free</Button>
                                    </Col>
                                </Row>
                            </Col>
