...
export default class Contact extends Component {
    render() {
        return (
            <>
                <div className="justify-content-center align-content-center py-5 px-5" id="contact">
                    <Row className="justify-content-center">
                        <Col sm="12" md="6" lg="8" className="justify-content-center">
                            <Row className="justify-content-center">
                                <Col sm="12" md="9" lg="8" className="justify-content-center">
                                    <Row className="justify-content-center">
                                                        ...
                                                        <Col md="6" lg="6" sm="6" className="justify-content-center">
                                                            <Row className="justify-content-center">
                                                                <Col md="12" lg="12" sm="12" className="justify-content-center">
                                                                    <Button className="justify-content-center btn border-0 btn-info rounded-pill btn-block" active>
                                                                        SEND
                                                                    </Button>
                                                                </Col>
                                                            </Row>
