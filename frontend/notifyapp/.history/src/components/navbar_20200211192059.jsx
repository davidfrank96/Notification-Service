...
export default class NavBar extends Component {
    ...
    render() {
        return (
            <>
                <Navbar fixed="top" color={this.state.color} dark expand="md" className="shadow-lg shadow">
                    <NavbarBrand href="/" className="text-dark">Notify App</NavbarBrand>
                    <NavbarToggler className="navbar-toggler-icon" style={{ border: "none" }} onClick={
                        () => {
