                                ...
                                <Row className="h-100 justify-content-center">
                                    <Col lg="4" md="4" sm="12" className="h-100 justify-content-center">
                                        <InputGroup className="p-1 rounded-pill">
                                            <InputGroupAddon style={{ backgroundImage: `url(${euimg})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat" }} className=" rounded-left justify-content-center p-1" addonType="prepend">
